...
export default class SpFxHttpClientDemo extends React.Component<ISpFxHttpClientDemoProps, {}> {
  ...
  public render(): React.ReactElement<ISpFxHttpClientDemoProps> {
    const {
      spListItems,
      isDarkTheme,
      environmentMessage,  // By using object destructuring in this way, the code makes it easier 
      hasTeamsContext,    //to access these properties within the component without needing to 
      userDisplayName //refer to this.props every time.
} = this.props;
